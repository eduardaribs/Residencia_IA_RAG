...
| Operation  Parameters  FLOPs per Token  Embed  (  n  vocab  +  n  ctx  )  d  model  4  d  model  Attention: QKV  n  layer  d  model  3  d  attn  2  n  layer  d  model  3  d  attn  Attention: Mask  -  2  n  layer  n  ctx  d  attn  Attention: Project  n  layer  d  attn  d  model  2  n  layer  d  attn  d  embd  Feedforward  n  layer  2  d  model  dff  2  n  layer  2  d  model  dff  De-embed  -  2  d  model  n  vocab  Total (Non-Embedding)  N  = 2  d  model  n  layer  (2  d  attn  +  dff  )  C  forward  = 2  N  +2  n  layer  n  ctx  d  attn   |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| Parameter  α  N  α  D  N  c  D  c  Value  0  .  076  0  .  103  6  .  4  ×  10  13  1  .  8  ×  10  13   |
|----------------------------------------------------------------------------------------------------------|
...
| Parameter  α  N  α  S  N  c  S  c  Value  0  .  077  0  .  76  6  .  5  ×  10  13  2  .  1  ×  10  3   |
|--------------------------------------------------------------------------------------------------------|
...
| Parameters  Data  Compute  Batch Size  Equation  N  ∞  ∞  Fixed  L  (  N  ) = (  N  c  /N  )  α  N  ∞  D  Early Stop  Fixed  L  (  D  ) = (  D  c  /D  )  α  D  Optimal  ∞  C  Fixed  L  (  C  ) = (  C  c  /C  )  α  C  (naive)  N  opt  D  opt  C  min  B  ≪  B  crit  L  (  C  min  ) =  (  C  min  c  /C  min  )  α  min  C  N  D  Early Stop  Fixed  L  (  N,D  ) =  [  (  N  c  N  )  α N  α D  +  D  c  D  ]  α  D  N  ∞  S  steps  B  L  (  N,S  ) =  (  N  c  N  )  α  N  +  (  S  c  S  min  (  S,B  )  )  α  S   |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| Power Law  Scale (tokenization-dependent)  α  N  = 0  .  076  N  c  = 8  .  8  ×  10  13  params (non-embed)  α  D  = 0  .  095  D  c  = 5  .  4  ×  10  13  tokens  α  C  = 0  .  057  C  c  = 1  .  6  ×  10  7  PF-days  α  min  C  = 0  .  050  C  min  c  = 3  .  1  ×  10  8  PF-days  α  B  = 0  .  21  B  ∗  = 2  .  1  ×  10  8  tokens  α  S  = 0  .  76  S  c  = 2  .  1  ×  10  3  steps   |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| Compute-Efficient Value  Power Law  Scale  N  opt  =  N  e  ·  C  p  N  min  p  N  = 0  .  73  N  e  = 1  .  3  ·  10  9  params  B  ≪  B  crit  =  B  ∗  L  1  /α B  =  B  e  C  p  B  min  p  B  = 0  .  24  B  e  = 2  .  0  ·  10  6  tokens  S  min  =  S  e  ·  C  p  S  min  (lower bound)  p  S  = 0  .  03  S  e  = 5  .  4  ·  10  3  steps  D  opt  =  D  e  ·  C  p  D  min  (1 epoch)  p  D  = 0  .  27  D  e  = 2  ·  10  10  tokens   |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
which implies that for compute-efficient training, we should train to a fi xed percentage α N α S ≈ 10% above the converged loss. Next, let's determine how the optimal loss depends on the compute budget. Eliminating N yields a power-law dependence of performance on compute:
